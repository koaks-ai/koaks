 ...
 *
 * Generation/sampling parameters are NOT carried here: they bind to the model and
 * are set in the provider DSL, so each provider builds them from its own native
 * config in `ChatModel.toWire`.
 *
