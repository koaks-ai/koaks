...
class JsTestHttpClient {

    val jsClient = KtorHttpClient(
        HttpClientConfig(
    ...
    fun jsTestSyncRequest() = runTest {
        ...
        val stringResult = jsClient.postAsObject<FullChatRequest, ChatResponse>(request)
    ...
    fun jsTestStreamRequest() = runTest {
        ...
        var chunkCount = 0
        jsClient.postAsObjectStream<FullChatRequest, ChatResponse>(request)
            .map { data ->
                chunkCount++
